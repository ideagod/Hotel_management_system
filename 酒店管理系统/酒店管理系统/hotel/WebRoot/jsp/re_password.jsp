...
<html>
	...
	<head>
		...
		<script src="/hotel/framework/cframe.js"></script><!-- 仅供所有子页面使用 -->
		<!-- 公共样式 结束 -->
	...
	<body>
		...
		<div class="reg_div2">	<a href="/hotel/jsp/re_information.jsp">修改</a>
			
	<form action="${pageContext.request.contextPath}/re_passwordServlet.do"
		...
		<tr >
			<td>*账号: </td>	
			<td>141414
			<input type="hidden" name="user_name" value=141414 readonly class="reg_td1" id="username"></td>	
		</tr>
