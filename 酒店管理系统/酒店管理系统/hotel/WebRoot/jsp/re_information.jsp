...
<html>
	...
	<div class="reg_div2">
		...
		<tr >
			...
			<td class="reg_div1_infor"><input type="text" name="address" value="吉林大学珠海学院"class="reg_td1"></td>
			<td><span class="reg_sp6" id="reg_sp6"></span></td>
		</tr>
		<tr></tr>
		<tr >	
			<td class="reg_div1_infor">*联系电话: </td> 
			<td class="reg_div1_infor"> <input type="text" name="phone"  value=10086 class="reg_td1" id="phone"></td>	
