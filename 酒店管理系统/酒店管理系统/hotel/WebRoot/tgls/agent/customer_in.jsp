	...
	<c:choose>
     <c:when test="${list2.currentPage<=1}">
          <li><a>上一页</a></li> 
        	...
        	<c:otherwise>  
	<li><a href="${pageContext.request.contextPath}/customer_information_Servlet.do?&page=${list2.currentPage-1}">上一页</a></li>
		 </c:otherwise>
	    	</c:choose>
	...
	<c:choose>
     <c:when test="${list2.currentPage>=list2.totalpage}">
         <li><a>下一页</a></li>
        	...
        	<c:otherwise>
	<li><a href="${pageContext.request.contextPath}/customer_information_Servlet.do?&page=${list2.currentPage+1}">下一页</a></li>
	 </c:otherwise>
	    	</c:choose>
