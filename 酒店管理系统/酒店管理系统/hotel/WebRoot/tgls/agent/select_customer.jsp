			...
			<div class="console">
				<form class="layui-form" action="/hotel/select_customerServlet.do">
					<div class="layui-form-item">
						...
						<a class="layui-btn" lay-submit lay-filter="formDemo" href="/hotel/customer_information_Servlet.do" >返回</a>
					</div>
	...
	<c:choose>
     <c:when test="${cust1.currentPage<=1}">
          <li><a>上一页</a></li> 
        	...
        	<c:otherwise>  
	<li><a href="${pageContext.request.contextPath}/select_customerServlet.do?&page=${cust1.currentPage-1}">上一页</a></li>
		 </c:otherwise>
	    	</c:choose>
	...
	<c:choose>
     <c:when test="${cust1.currentPage>=cust1.totalpage}">
         <li><a>下一页</a></li>
        	...
        	<c:otherwise>
	<li><a href="${pageContext.request.contextPath}/select_customerServlet.do?&page=${cust1.currentPage+1}">下一页</a></li>
	 </c:otherwise>
	    	</c:choose>
