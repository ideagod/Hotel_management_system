	...
	<c:choose>
     <c:when test="${list3.currentPage<=1}">
          <li><a>上一页</a></li> 
        	...
        	<c:otherwise>  
	<li><a href="${pageContext.request.contextPath}/renew_roomServlet.do?&page=${list3.currentPage-1}">上一页</a></li>
		 </c:otherwise>
	    	</c:choose>
	...
	<c:choose>
     <c:when test="${list3.currentPage>=list3.totalpage}">
         <li><a>下一页</a></li>
        	...
        	<c:otherwise>
	<li><a href="${pageContext.request.contextPath}/renew_roomServlet.do?&page=${list3.currentPage+1}">下一页</a></li>
	 </c:otherwise>
	    	</c:choose>
