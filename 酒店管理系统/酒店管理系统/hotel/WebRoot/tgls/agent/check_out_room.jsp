	...
	<c:choose>
     <c:when test="${list4.currentPage<=1}">
          <li><a>上一页</a></li> 
        	...
        	<c:otherwise>  
	<li><a href="${pageContext.request.contextPath}/check_out_roomServlet.do?&page=${list4.currentPage-1}">上一页</a></li>
		 </c:otherwise>
	    	</c:choose>
	...
	<c:choose>
     <c:when test="${list4.currentPage>=list4.totalpage}">
         <li><a>下一页</a></li>
        	...
        	<c:otherwise>
	<li><a href="${pageContext.request.contextPath}/check_out_roomServlet.do?&page=${list4.currentPage+1}">下一页</a></li>
	 </c:otherwise>
	    	</c:choose>
