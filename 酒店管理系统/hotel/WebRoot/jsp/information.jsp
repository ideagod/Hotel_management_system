...
<body>
	...
	<div class="reg_div2">
		...
		<table id="customers">
			...
			<tr class="alt">
				<td>*账号:</td>
				<td class="reg_div1_infor">001</td>
			</tr>
			<tr>
				<td>*姓名:</td>
				<td class="reg_div1_infor">赖幸</td>
			</tr>
			<tr>
				<td>*性别:</td>
				<td class="reg_div1_infor">女</td>
			</tr>
			<tr>
				<td>*专业:</td>
				<td class="reg_div1_infor">0</td>
			</tr>
			<tr>
				<td>*地址:</td>
				<td class="reg_div1_infor">吉林大学珠海学院</td>
			</tr>
			<tr>
				<td>*联系电话:</td>
				<td class="reg_div1_infor">10086</td>
			</tr>
