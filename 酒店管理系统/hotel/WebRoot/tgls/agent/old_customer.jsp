	...
	background-color: #ddd;
		...
		<ul class="pagination">
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${pageContext.request.contextPath}/old_customerServlet.do?&page=${list5.currentPage-1}">上一页</a></li>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${pageContext.request.contextPath}/old_customerServlet.do?&page=${list5.currentPage+1}">下一页</a></li>
				</c:otherwise>
			</c:choose>
