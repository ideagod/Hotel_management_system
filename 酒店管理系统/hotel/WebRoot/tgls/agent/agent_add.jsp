           	   ...
           	   无数据
						...
						<c:otherwise>
							<tr>
								...
								<td>${list1.price}</td>
								<td><input class="layui-btn layui-btn-xs" type="button"
									onclick="location='#modal-one'" value="入住" /></td>
								<td><input class="layui-btn layui-btn-xs" type="button"
									onclick="javascript:window.open('${list1.img}')" value="房间信息" />
								</td>
								<div class="modal" id="modal-one" aria-hidden="false">
									<div class="modal-dialog">
										...
										<div class="modal-body">
											...
											<p>
												<input type="hidden" name=room_num3
													value="${list1.room_num}">
											</p>
											<p>
											...
											<p>
												...
												<input type="radio" name="sex" value="女" maxlength="16" />女
											</p>
											...
											<p>
												入住时间：<input type="text" name="in_time" value=<%=s%>>
											</p>
											<p>
												入住天数：<select name="in_day">
	...
	background-color: #ddd;
		...
		<ul class="pagination">
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${pageContext.request.contextPath}/add_roomServlet.do?&page=${list1.currentPage-1}">上一页</a></li>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${pageContext.request.contextPath}/add_roomServlet.do?&page=${list1.currentPage+1}">下一页</a></li>
				</c:otherwise>
			</c:choose>
