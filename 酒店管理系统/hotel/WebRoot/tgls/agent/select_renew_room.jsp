	...
	<div class="cBody">
		<div class="console">
			...
			<a class="layui-btn" lay-submit lay-filter="formDemo"
				href="/hotel/renew_roomServlet.do">返回</a>
		</div>
	</div>
...
ul.pagination li a:hover:not (.active ) {
	...
	<ul class="pagination">
		...
		<c:choose>
			...
			<c:otherwise>
				<li><a
					href="${pageContext.request.contextPath}/renew_roomServlet.do?&page=${cust3.currentPage-1}">上一页</a></li>
			</c:otherwise>
		</c:choose>
		...
		<c:choose>
			...
			<c:otherwise>
				<li><a
					href="${pageContext.request.contextPath}/renew_roomServlet.do?&page=${cust3.currentPage+1}">下一页</a></li>
			</c:otherwise>
		</c:choose>
