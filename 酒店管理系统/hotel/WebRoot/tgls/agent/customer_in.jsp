	...
	background-color: #ddd;
		...
		<ul class="pagination">
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${pageContext.request.contextPath}/customer_information_Servlet.do?&page=${list2.currentPage-1}">上一页</a></li>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${pageContext.request.contextPath}/customer_information_Servlet.do?&page=${list2.currentPage+1}">下一页</a></li>
				</c:otherwise>
			</c:choose>
