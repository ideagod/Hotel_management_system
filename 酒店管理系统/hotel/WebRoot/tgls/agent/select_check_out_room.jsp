			...
			<form class="layui-form"
				...
				<div class="layui-form-item">
					...
					<a class="layui-btn" lay-submit lay-filter="formDemo"
						href="/hotel/check_out_roomServlet.do">返回</a>
				</div>
			</form>
		</div>
		<%
	...
	background-color: #ddd;
		...
		<ul class="pagination">
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${pageContext.request.contextPath}/check_out_roomServlet.do?&page=${cust2.currentPage-1}">上一页</a></li>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${pageContext.request.contextPath}/check_out_roomServlet.do?&page=${cust2.currentPage+1}">下一页</a></li>
				</c:otherwise>
			</c:choose>
