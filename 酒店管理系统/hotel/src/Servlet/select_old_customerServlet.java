...
public class select_old_customerServlet extends HttpServlet {
	 ...
	 public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  
	    ...
	    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  {  
			...
			pageResult<customer> cust4=customerDao.select_old_customer_bypage(page, customer_information);
			 session.setAttribute("cust4", cust4);	
				response.sendRedirect("tgls/agent/select_old_customer.jsp");
		}
		catch (Exception e) {
			e.printStackTrace();
